...
<p>Hello manager,welcome to the employee reward system(ERS) your tasks here are to key in the employee production details which are used to calculate the reward. So you can try to key in the details of the employees who already have an account here. </p>
